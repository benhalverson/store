...
const InputField = ({ id, label, autoComplete, value, onChange }: InputFieldProps) => {
	return (
		<div>
			<label htmlFor={id} className="block text-sm/6 font-medium text-gray-700 dark:text-gray-300">
				{label}
			</label>
			<div className="mt-2">
				<input
